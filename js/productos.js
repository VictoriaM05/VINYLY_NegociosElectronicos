...
const productos = [
  ...
  { id: 6,  nombre: "Piel de Papel",     artista: "Iker Ramos",  precio: "$420 MXN", imagen: "img-6",  descripcion: "Producción íntima y acústica, grabada casi en vivo para capturar cada textura del sonido." },
  { id: 7,  nombre: "Satélite",          artista: "Nova Reyes",  precio: "$460 MXN", imagen: "img-7",  descripcion: "El segundo álbum de Nova Reyes, con una producción más ambiciosa y un sonido que viaja entre el pop y el synth-wave." },
  ...
  { id: 11, nombre: "Romance",        artista: "Camila Cabello",  precio: "$700 MXN", imagen: "img-1", foto: "resources/romance_disco.jpg", descripcion: "El tercer álbum de estudio de Camila Cabello, una declaración de amor pop con toques latinos, ahora disponible en vinilo." },
  { id: 12, nombre: "Back To Black",        artista: "Amy Winehouse",  precio: "$650 MXN", imagen: "img-2", foto: "resources/backtoblack_disco.jpg", descripcion: "..." },
  { id: 13, nombre: "Thank U Next",       artista: "Ariana Grande",  precio: "$760 MXN", imagen: "img-3", foto: "resources/thankunext_disco.jpg", descripcion: "..." },
];
